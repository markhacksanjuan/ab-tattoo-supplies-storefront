...
export async function getProducts(params = {}) {
    try {
        ...
        const queryParams = {
            ...
            // thumbnail/metadata (for image carousel), and variant id (for
            // addToCart).  All of those scalar fields are included by
            // *variants.  We intentionally OMIT:
            ...
            // always redundant.
            fields: '*variants,*variants.prices,+type,+collection,+categories,+tags,+images',
        }
